            ...
            <div className="w-full flex items-center justify-center py-8 px-8 s:px-12 md:px-16">
                <div className="w-full flex items-center justify-between">
                        ...
                        <div className="items-center justify-center gap-16 flex lg:hidden">
                          <button className="bg-[#f9f9f9] text-black p-2 w-full h-full rounded-full font-bold flex items-center justify-center flex-col">
                           <div className="flex items-center justify-center flex-col gap-1 w-8 h-8 rounded-full p-1"> <span className="w-[1.2rem] h-[1px] bg-black rounded-[1px]"></span>
                            <span className="w-[1.2rem] h-[1px] bg-black rounded-[1px]"></span></div>
                          </button>
                        </div>
                </div>
            </div>
