...
const HeroSection = () => {
  return (
    <section className="h-full w-screen min-h-screen max-w-screen-2xl mx-auto relative bg-black flex items-center justify-center">
      <div className="absolute w-screen min-h-screen h-full scale-x-[-1]">
        <video
          src={video}
          alt="video"
      ...
      <div className="flex items-center justify-center z-[1] w-screen h-full">
        <div className="flex items-center justify-center w-full h-full py-8 px-8 s:px-12 md:px-16">
          <div className="flex items-center justify-center w-full pt-24 h-full">
            <div className="flex items-center justify-center w-full pt-6 xs:pt-8 s:pt-12 md:pt-16 lg:pt-24 xl:pt-32 h-full flex-col gap-8 pb-8">
              <div className="flex items-start w-full justify-end flex-col flex-1 ">
                <h1 className="text-4xl xs:text-5xl s:text-6xl sm:text-7xl md:text-8xl lg:text-9xl text-white font-bold">Solve Hard </h1>
                <h1 className="text-4xl xs:text-5xl s:text-6xl sm:txt-7xl md:text-8xl lg:text-9xl text-white font-bold">
                  Climate Problems
                </h1>
              </div>
              <div className="flex items-end w-full justify-start">
                <div className="w-[90%] md:w-[50%] flex items-end justify-start">
                  {" "}
                  <p className="text-[#706f6f] text-sm xs:text-base s:text-lg sm:text-xl">
